...
const Sidebar = () => {
  ...
  return (
    // Sidebar
    <aside className="fixed top-16 bottom-0 left-0 w-50 md:w-64 border-r bg-sidebar/95 md:bg-sidebar md:static transfrom transition-all duration-200 opacity-0 -translate-x-full md:opacity-100 md:translate-x-0 sidebar min-h-[calc(100vh-4rem)] z-100">
      {/* Navigation */}
