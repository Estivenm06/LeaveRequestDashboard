...
const Sidebar = () => {
  ...
  const styleButtonDefault =
    "inline-flex gap-1 items-center p-2 rounded-sm transition-all duration-200 shadow-lg hover:scale-105";
      ...
      <nav className="flex flex-col gap-5">
        <ul>
          <Link
            href={"/"}
            className={`${
              pathName === "/" && "bg-blue-500 hover:bg-blue-700 text-white"
            } ${styleButtonDefault}`}
          >
        ...
        <ul>
          <Link
            href={"/leave_requests"}
            className={`${
              pathName === "/leave_requests" && "bg-blue-500"
            } ${styleButtonDefault}`}
          >
